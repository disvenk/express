$('#courierCostAdd').click(function () {
    location.href='courierCostAddHtml';
})
...
layui.use(['table', 'layer','form'], function () {
    ...
    table.render({
        ...
        , cols: [[
              {field: 'schoolName', sort: true, title: '网点名称', align: 'center'}
            , {field: 'typeName', sort: true, title: '上门类型', align: 'center'}
            , {field: 'fee', title: '最低上门费', align: 'center'}
...
//                layer.msg('编辑第'+data.id+'行');
            location.href = 'courierCostEditHtml?id='+data.id+'';
        }
    });
});
